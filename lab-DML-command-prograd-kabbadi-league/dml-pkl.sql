...
insert into referee values(5,'Arun');
 select * from referee;


--3. Insert into innings

insert into innings values(1,5);
select * from innings
...
select * from skill;
 ...
 --6. Insert into team
       ...
       insert into team values(1,'Arun','sharth',2,3);
       select * from team;
       

--7. Insert into player

insert into player values(3,'Arun','india',3,1);
select * from player;
--8. Insert into venue
insert into venue values(2,'chennai',3);
select * from venue;

--9. Insert into event
insert into event values(1,1,1,2,1,3,25,20,20);
select * from event;

--10. Insert into extra_event

insert into extra_event values(2,2,5,5,5);
    select * from extra_event;
--11. Insert into outcome

insert into outcome values(1,'winner',2,20,32);
select * from outcome;
--12. Insert into game
...
UPDATE player SET name='keerthu' WHERE ID=2;
SELECT * FROM PLAYER;
...
UPDATE player SET country='India' WHERE name='Arun';
SELECT * FROM PLAYER;
